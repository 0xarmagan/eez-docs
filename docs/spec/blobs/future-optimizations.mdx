...
sidebar_label: "Future Optimizations"
description: "Blob-encoding optimizations under consideration but not yet part of the format."
---

Deferred size optimizations for the blob message format
([[`BLOB_FORMAT_SPEC.md`](/spec/blobs/blob-format)](/spec/blobs/blob-format)). Version 1 of the format deliberately
...
[[`U256_COMPRESSED_CODEC.md`](/spec/blobs/u256-codec)](/spec/blobs/u256-codec), with conformance test vectors
in [`U256_COMPRESSED_CODEC_VECTORS.json`](https://github.com/eez-association/eez-core-protocol/blob/main/docs/blobs/U256_COMPRESSED_CODEC_VECTORS.json). Typical
