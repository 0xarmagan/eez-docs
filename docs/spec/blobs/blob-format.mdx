---
title: "Standardized Message Format"
sidebar_label: "Blob Format"
description: "The wire format for the cross-chain message stream: framing, message types, encoding, and validity rules."
---
...
[[`FUTURE_OPTIMIZATIONS.md`](/spec/blobs/future-optimizations)](/spec/blobs/future-optimizations).
