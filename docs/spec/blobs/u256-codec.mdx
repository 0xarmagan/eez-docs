...
sidebar_label: "u256 Codec"
description: "The single-byte-prefix codec that compresses common 256-bit values, with the full format table and a reference implementation."
---
...
[`U256_COMPRESSED_CODEC_VECTORS.json`](https://github.com/eez-association/eez-core-protocol/blob/main/docs/blobs/U256_COMPRESSED_CODEC_VECTORS.json) carries
